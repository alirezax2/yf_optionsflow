...
option_chain_data_combined.to_csv(
    os.path.join(outputfolder, "optionchain.csv"), index=False
)

file_path = rf"{outputfolder}/optionchain_{current_datetime}.csv"
latest_file_path = rf"{outputfolder}/optionchain.csv"
...
upload_to_hf_dataset(
    file_path, dataset_name_YfOptions_output, HF_TOKEN_YfOptions, repo_type="dataset"
)
upload_to_hf_dataset(
    latest_file_path,
    dataset_name_YfOptions_output,
    HF_TOKEN_YfOptions,
    repo_type="dataset",
)
